from toolbox.extract import extract
...
class DataSet:
    ...
    def _extract(self):
        self._time, self._ch1 = extract(self._ch1_filepath, xcol=TIME_COLUMN, ycol=VOLTAGE_COLUMN)
        _, self._ch2 = extract(self._ch2_filepath, xcol=TIME_COLUMN, ycol=VOLTAGE_COLUMN)
